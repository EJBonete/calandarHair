...
public class EditarCitaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        labelNombre= (EditText) findViewById(R.id.editText_name_edicionCitas);

        labelNombre.setText(datoNombre);
        ...
        boton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                pasarPantalla = new Intent(EditarCitaActivity.this, AccesoActivity.class);
                finish();
